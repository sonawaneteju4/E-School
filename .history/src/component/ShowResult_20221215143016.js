  ...
  return (
    <>
      <div className="container bg-secondary p-2 text-dark bg-opacity-10">
        ...
        <div className="">
        <p className="d-inline-block px- text-start">Total Marks: </p>
        <p className="d-inline-block px- text-center">Mark Obtain: </p>
        <p className="d-inline-block px- text-end">Grade: </p>
        </div>
      </div>
    </>
  );
