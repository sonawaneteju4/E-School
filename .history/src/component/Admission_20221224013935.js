...
const gen = [
  ...
  { label: "Female", value: "Geo" },
];
const Admission = () => {
  const [msg, setmsg] = useState();
  const [admission, setAdmission] = useState({name: "", email: "", phone: "", gender: "", education: "", subject: "", college: "", status: "", city: "",
  });

  const { name, email, phone, gender, education, subject, college, status, city,
  } = admission;
