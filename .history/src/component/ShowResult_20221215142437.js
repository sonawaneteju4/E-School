  ...
  return (
    <>
      <div className="container bg-secondary p-2 text-dark bg-opacity-10">
        ...
        <div className="position-absolute m-2 top-0 start-0 translate-midd e">Total Marks: </div>
        <div className="position-absolute m-2 top-0 start-50 translate-mid le">Mark Obtain: </div>
        <div className="position-absolute m-2 top-0 start-100 translate-mi dle">Grade: </div>
        </div>
      </div>
    </>
  );
