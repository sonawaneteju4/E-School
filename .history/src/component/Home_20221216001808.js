...
const Home = () => {
  ...
  <div className="carousel-inner">
    ...
    <div className="carousel-item" data-bs-interval="2000">
      <img className='text-light' src="/image/yoga2.jpeg" className="d-block w-100" alt="..."/>
      <div className="carousel-caption d-none d-md-block">
        <h5>International Yoga Day</h5>
        <p> Yoga gives us the lesson to cure what is fatal to be endured and to endure what you cannot cure.</p>
      </div>
    </div>
