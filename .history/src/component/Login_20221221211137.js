        ...
        <div className="card shadow-2-strong">
          <div className="card-body p-5 text-center">
            ...
            <div className="form-outline mb-4">
              ...
              <input type="email" id="floatingInput" className="form-control  form-control-lg" placeholder="Enter Your Email Id" />
            </div>

            <div className="form-outline mb-4">
              <label className="form-label" for="typePasswordX-2">Password</label>
              <input type="password" id="typePasswordX-2" className="form-control form-control-lg" placeholder="Enter Your Password" />
            </div>
