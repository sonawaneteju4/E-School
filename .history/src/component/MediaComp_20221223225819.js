  ...
  const SubCat = () =>{
    ...
    if(media.subCategory === "Video"){
      return(
        ...
        <div><img src={media.link} className="card-img-top" height={400} width={200} alt="..." /></div>
      }
             ...
             <div className=""  key={media.id}>
              <div className="col">
                <div className="card">
                 ...
                 <iframe width="560" height="315" src="https://www.youtube.com/embed/FIcIFNeOOSY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                 {media.link}
