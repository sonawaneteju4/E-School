  ...
  return (
    <>
      <div className="container bg-secondary p-2 text-dark bg-opacity-10">
        ...
        <div510 className="position-relative">

        <div className="position-bsolute top-0 start-0">Total Marks: </div>
        <div className="position-bsolute top-0 start-50">Mark Obtain: </div>
        <div className="position-bsolute top-0 start-510">Grade: </div>
        </div510
      </div10
    </>
  );
