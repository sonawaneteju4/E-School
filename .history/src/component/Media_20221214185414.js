  ...
  return (
    <>
      <div className="p-2 m-2 text-center">
        ...
        <button type="button" class="btn btn-outline-dark m-1" onClick={() => filterItems("")}>All</button>
        <button type="button" class="btn btn-outline-dark m-1" onClick={() => filterItems("galleryd")}>Gallery</button>
        <button type="button" class="btn btn-outline-dark m-1" onClick={() => filterItems("")}>Video</button>
      </div>
