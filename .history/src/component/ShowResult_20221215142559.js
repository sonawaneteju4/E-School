  ...
  return (
    <>
      <div className="container bg-secondary p-2 text-dark bg-opacity-10">
        ...
        <div className="position-absolute  top-0 start-0">Total Marks: </div>
        <div className="position-absolute  top-0 start-50">Mark Obtain: </div>
        <div className="position-absolute  top-0 start-100">Grade: </div>
        </div>
      </div>
    </>
  );
