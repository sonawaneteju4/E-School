  ...
  return (
    <>
      <div className="p-2 m-2 text-center">
        ...
        <button type="button" class="btn btn-outline-dark m-1">All</button>
        <button type="button" class="btn btn-outline-dark m-1">Gallery</button>
        <button type="button" class="btn btn-outline-dark m-1">Video</button>
      </div>
