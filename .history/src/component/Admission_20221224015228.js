...
const Admission = () => {
  ...
  const [admission, setAdmission] = useState({name: "", email: "", phone: "", gender: "", education: "", subject: "", college: "",  city: "",
  });
  ...
  let handleSubmit = async (e) => {
    e.preventDefault();
    try {
      let res = await fetch("http://localhost:5000/api/admission/postadmision", {
        method: "POST",
        headers: {
              ...
              <div
                ...
                <div className="card-body p-4 p-md-5">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="row">
                      <div className="form-floating col-md-6 mb-4 pb-2  mb-3">
                        <select
                      ...
                      <div className="form-floating col-md-6 mb-4 pb-2 col-12">
                        <select
                          className="form-select"
                          id="floatingSelect"
                          name="gender"
