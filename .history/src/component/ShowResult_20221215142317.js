  ...
  return (
    <>
      <div className="container bg-secondary p-2 text-dark bg-opacity-10">
        ...
        <div className="position-absolute p-2 top-0 start-0 translate-middle">Total Marks: </div>
        <div className="position-absolute p-2 top-0 start-50 translate-middle">Mark Obtain: </div>
        <div className="position-absolute p-2 top-0 start-100 translate-middle">Grade: </div>
        </div>
      </div>
    </>
  );
