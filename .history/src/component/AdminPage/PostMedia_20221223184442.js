                  ...
                  <div className="card shadow-2-strong">
                    <div className="card-body p-5 text-center">
                      ...
                      <div className="form-floating mb-3">
                        ...
                        />
                        <label htmlhtmlhtmlhtmlfor="floatingInput">Title</label>
                      </div>
                      <div className="form-floating mb-3">
                        <input
                          type="link"
                          ...
                          placeholder="name@example.com"
                        />
                        <label htmlhtmlhtmlhtmlfor="floatingInput">Link</label>
                      </div>
                      <div className="form-floating mb-3">
                        <textarea
                          type="description"
                          ...
                          placeholder="name@example.com"
                          />
                        <label htmlhtmlhtmlhtmlfor="floatingTextarea2">Description</label>
                      </div>
                      <div className="form-floating mb-3">
                        <select
                        ...
                        <label htmlhtmlhtmlfor="floatingSelect">Select Media Category</label>
                      </div>
                      <div className="form-floating mb-3">
                        <select
                          className="form-select"
                        ...
                        <label htmlhtmlhtmlfor="floatingSelect">Select Media Type</label>
                      </div>
                      <div className="form-floating mb-3">
                        <input
                          type="coustomLink"
                          ...
                          placeholder="name@example.com"
                        />
                        <label htmlhtmlhtmlfor="floatingInput">Coustom Link</label>
                      </div>
