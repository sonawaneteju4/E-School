...
const PostMedia = () => {
  const [msg, setmsg] = useState();
    const [blog, setBlog] = useState({title: "", description: "", link: "",coustomLink:"",subCategory:"",})


      const getInitialState = () => {
        const category = "Orange";
        return category;
      };
    
      const [category, setValue] = useState(getInitialState);
    
      const handleChange = (e) => {
        setValue(e.target.value);
      };

    const {name, description, link, coustomLink,subCategory} = blog
