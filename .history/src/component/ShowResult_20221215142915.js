  ...
  return (
    <>
      <div className="container bg-secondary p-2 text-dark bg-opacity-10">
        ...
        <div className="">
        <div className="d-inline-block text-start">Total Marks: </div>
        <div className="d-inline-block text-center">Mark Obtain: </div>
        <div className="d-inline-block text-end">Grade: </div>
        </div>
      </div>
    </>
  );
