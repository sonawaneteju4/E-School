...
const Home = () => {
  return (
    <>
      ...
      <div classNzm="modal" tabindex="-1">
  <div classNzm="modal-dialog">
    <div classNzm="modal-content">
      <div classNzm="modal-header">
        <h5 classNzm="modal-title">Modal title</h5>
        <button type="button" classNzm="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div classNzm="modal-body">
        <p>Modal body text goes here.</p>
      </div>
      <div classNzm="modal-footer">
        <button type="button" classNzm="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" classNzm="btn btn-primary">Save changes</button>
      </div>
    </div>
  </div>
</div>
