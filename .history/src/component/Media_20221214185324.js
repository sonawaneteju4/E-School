  ...
  return (
    <>
      <div className="p-2 m-2 text-center">
        ...
        <button type="button" class="btn btn-outline-dark m-1" on>All</button>
        <button type="button" class="btn btn-outline-dark m-1" on>Gallery</button>
        <button type="button" class="btn btn-outline-dark m-1" on>Video</button>
      </div>
