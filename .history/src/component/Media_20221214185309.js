  ...
  return (
    <>
      <div className="p-2 m-2 text-center">
        ...
        <button type="button" class="btn btn-outline-dark m">All</button>
        <button type="button" class="btn btn-outline-dark m">Gallery</button>
        <button type="button" class="btn btn-outline-dark m">Video</button>
      </div>
